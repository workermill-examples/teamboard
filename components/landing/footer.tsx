  ...
  return (
    <footer className="bg-secondary-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Main footer content */}
        <div className="py-16">
          {/* Built by WorkerMill section with badge */}
          <div className="text-center mb-12">
            <div className="inline-flex items-center space-x-3 mb-4">
              <span className="text-secondary-400 text-sm">Built by</span>
              <a
            ...
            <p className="text-secondary-500 text-sm max-w-2xl mx-auto">
              TeamBoard is a demonstration project showcasing modern full-stack development
              with Next.js, TypeScript, and enterprise-grade architecture.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a href="#how-it-works" className="text-secondary-400 hover:text-white transition-colors">
                    How it works
                  </a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href="https://workermill.com/contact"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-secondary-400 hover:text-white transition-colors"
                  >
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <a
                    href="https://github.com/workermill-examples/teamboard#readme"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-secondary-400 hover:text-white transition-colors"
                  >
                ...
                <li>
                  <a
                    href="https://workermill.com/blog"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-secondary-400 hover:text-white transition-colors"
                  >
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-white font-semibold">TeamBoard</span>
              </div>
              <span className="text-secondary-500 text-sm">
                © {new Date().getFullYear()} WorkerMill. Demo project.
              </span>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <a
                href="https://twitter.com/workermill"
                target="_blank"
                rel="noopener noreferrer"
                className="text-secondary-400 hover:text-white transition-colors"
                aria-label="Twitter"
